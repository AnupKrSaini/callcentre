...
<Row>
    <Col md={12}>
        <Card>
            ...
            <Card.Body>
                <h4 className='text-success text-center' style={{marginTop:'30px'}}><b>{dataoutCalling.InsertRow ==0? '0 Records uploaded':dataoutCalling.InsertRow+' Records have been uploaded successfully'} </b></h4>
...
{dataoutCalling.tblOutboundList!=null?<Row className='mt15'>
    <Col md={12}>
        <Card>
            <Card.Header className='pb-0'>
                    ...
                    <Table  id='issueTbl'>
                        <thead className="thead-light">
                            <tr>
                                ...
                                <th scope="col"  style={{width:'12%'}}>Customer Mobile</th>
                                <th scope="col"  style={{width:'12%'}}>Source Type</th>
                                <th scope="col"  style={{width:'12%'}}>Source Name</th>
