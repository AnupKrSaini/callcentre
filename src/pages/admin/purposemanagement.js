...
const PurposeManagement = () => {
   ...
   TotalRecord:0,
                ...
                { let ds=data.Data;
                    if(ds!=null)
                    {
                        ...
                        await  SetPageHelper({
                            ...
                            dsPurposeList:ds.callCentrePurposeList==null?[]:ds.callCentrePurposeList
                        });
    ...
    const errorHandler = () => {
        ...
        if((formik.touched.purpose && formik.errors.purpose)||(formik.touched.purpose==undefined && formik.values.purpose==""))
        {
    ...
    const formik = useFormik({
        ...
        onSubmit:  async (values,actions) => {
                ...
                let options = {
                  ...
                  data:{ CallTypeId:'0', PurposeName:values.purpose}
                };
    ...
    const formikEdit = useFormik({
        ...
        onSubmit:  async (values) => {
                ...
                let options = {
                  ...
                  data:{PurposeId:values.purposeId, CallTypeId:'0', PurposeName:values.editpurpose}
                };
            ...
            <Container fluid>
                ...
                <Row>
                    <Col md={12}>
                        <Card>
                            <Card.Body>
                                <Form onSubmit={(e) => { e.preventDefault(); e.stopPropagation(); formik.handleSubmit(e)}}  onKeyDown={onKeyDown}>
                    ...
                    <Col md={12}>
                        <Card>
                            <Card.Header className='pb-0'>
                                <Card.Title>Purpose List </Card.Title>
                            </Card.Header>
                            <Card.Body>
