...
import CentreMasters from './pages/admin/master/CentreMasters';
import MachineMaster from './pages/admin/master/MachineMaster';
import DoctorMaster from './pages/admin/master/DoctorMaster';
...
import Government from './pages/admin/master/Government';

import CancelReport from './pages/admin/reports/CancelReport';
import CollectionReportUserWise from './pages/admin/reports/CollectionReportUserWise';
import LogReport from './pages/admin/reports/LogReport';
                            ...
                            {currentUser !== null || authenticated || jwt_token ?
                                ...
                                <App>
                                    ...
                                    */}
                                    ...
                                    <Route path={`${process.env.PUBLIC_URL}/admin/master/centre-masters`} component={CentreMasters} />
                                    <Route path={`${process.env.PUBLIC_URL}/admin/master/machine-master`} component={MachineMaster} />
                                    <Route path={`${process.env.PUBLIC_URL}/admin/master/doctor-master`} component={DoctorMaster} />
                                    <Route path={`${process.env.PUBLIC_URL}/admin/master/rate-plan`} component={RatePlan} />
                                    <Route path={`${process.env.PUBLIC_URL}/admin/master/rate-plan-mapping`} component={RatePlanMapping} />
                                    <Route path={`${process.env.PUBLIC_URL}/admin/master/corporate`} component={Corporate} />
                                    <Route path={`${process.env.PUBLIC_URL}/admin/master/government`} component={Government} />

                                    <Route path={`${process.env.PUBLIC_URL}/admin/reports/cancel-report`} component={CancelReport} />
                                    <Route path={`${process.env.PUBLIC_URL}/admin/master/collection-report-user-wise`} component={CollectionReportUserWise} />
                                    <Route path={`${process.env.PUBLIC_URL}/admin/master/log-report`} component={LogReport} />
