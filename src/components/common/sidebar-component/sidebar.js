...
import { USERMENUITEMS } from '../../../components/common/sidebar-component/usermenu';
        ...
        <Fragment>
            <div className="page-sidebar">
                <div className="main-header-left d-none d-lg-block" >
                    {UserType=='3'?<div className="logo-wrapper compactLogo">
                    ...
                    </div>:  <div className="logo-wrapper compactLogo">
